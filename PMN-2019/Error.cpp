...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(133, "Ошибка семантического анализа: Превышено значение INT (1 byte)"),
		...
		ERROR_ENTRY(140, "Ошибка семантического анализа: Несоответсвие параметровв объявленной и вызываемой функций"),
		...
		ERROR_ENTRY(606, "Ошибка семантического анализа: Ошибочный условный оператор"),
