...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(138, "Превышено значение INT (1 byte)"),
		...
		ERROR_ENTRY(142, "Несоответствие количества параметров в вызываемой функции"),
		ERROR_ENTRY(143, "Несоответствие типов в выражении"),
		ERROR_ENTRY(144, "Слишком много параметров в ф-ции"),
		ERROR_ENTRY(145, "Превышено количество функций"),
		ERROR_ENTRY(146, "Несоответсвие параметровв объявленной и вызываемой функций"),
		ERROR_ENTRY(147, "Несоответствие параметров встроенной функции"),
		ERROR_ENTRY(148, "Идентификатор не является левосторонним выражением"),
		...
		ERROR_ENTRY(601, "Ошибка в конструкции функции"),
		ERROR_ENTRY(602, "Ошибка в выражении"),
		ERROR_ENTRY(603, "Ошибка в параметрах функции"),
		ERROR_ENTRY(604, "Ошибка в параметрах вызываемой функции"),
		ERROR_ENTRY(605, "Ошибочный оператор"),
		ERROR_ENTRY(606, "Ошибочный условный оператор"),
